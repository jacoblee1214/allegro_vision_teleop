#!/usr/bin/env python3
"""
dataset_recorder_v6_1.py — VLA Model Dataset Recorder Node for Allegro Hand Teleoperation (V6 5-Finger & V4 4-Finger).
...
Subscribes to:
  ...
  2. `/allegro/joint_states_urdf` (sensor_msgs/msg/JointState): Actual joint positions, velocities, efforts
     in URDF coordinates (v6_1: left MCP motor offset removed by sim_bridge_node_v6_1, same frame as target_joints)
...
Usage:
    python3 dataset_recorder_v6_1.py [--sample-hz 60] [--output-dir /home/humble_ws/pinn_hw/results/episodes]
"""
