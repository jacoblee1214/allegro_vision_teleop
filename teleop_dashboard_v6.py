...
class TeleopDashboardWindow(QMainWindow):
    def __init__(self, device_id: int | str = "auto", target_fps: int = 60, hand_side: str = "left") -> None:
        super().__init__()
...
def main() -> None:
    ...
    parser.add_argument("--hand", default="left", choices=["left", "right"], help="Hand model side (default: left)")
